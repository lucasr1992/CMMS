...
const TextRefAlt: React.FC<PropriedadesInput> = ({ name, icon: Icon, ...rest}) => {  //o useField precisa de uma referencia dentro do input para saber qual o campo ele vai tratar, etou usando o "name", e o ...rest é para pegar qualquer tipo de informação que vem do input tipo password, email, etc
