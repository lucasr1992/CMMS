...
interface PropriedadesInput extends InputHTMLAttributes<HTMLTextAreaElement>{
  name: string;
...
const TextRef: React.FC<PropriedadesInput> = ({ name, icon: Icon, ...rest}) => {  //o useField precisa de uma referencia dentro do input para saber qual o campo ele vai tratar, etou usando o "name", e o ...rest é para pegar qualquer tipo de informação que vem do input tipo password, email, etc
  const inputValue = useRef<HTMLTextAreaElement>(null); // por causa do Typescript preciso informar q o useRef vai usar as propriedades do <HTMLInputElement>
